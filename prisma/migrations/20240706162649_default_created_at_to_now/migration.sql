...
INSERT INTO "new_Blog" ("body", "createdAt", "createdBy", "id", "status", "title", "updatedAt", "updatedBy") SELECT "body", "createdAt", "createdBy", "id", "status", "title", "updatedAt", "updatedBy" FROM "Blog";
DROP TABLE "Blog";
